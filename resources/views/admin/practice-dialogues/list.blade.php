...
<div class="card shadow-sm border-0">
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between mb-3">
            ...
            <form method="POST" action="{{ route('admin.practice-dialogues.manage') }}" class="d-flex">
                @csrf
                    ...
                    @if(request('language_id'))
                        <a href="{{ route('admin.practice-dialogues.manage') }}" class="btn btn-sm btn-warning">Reset</a>
                    @endif
            </form>
