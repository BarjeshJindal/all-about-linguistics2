@extends('layouts.vertical', ['title' => 'Manage Mock Test ', 'topbarTitle' => 'Manage Mock Test'])
...
<div class="card shadow-sm border-0">
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between mb-3">
            ...
            <form method="POST" action="{{ route('admin.mock-tests.manage') }}" class="d-flex">
                @csrf
                    ...
                    @if(request('language_id'))
                        <a href="{{ route('admin.mock-tests.manage') }}" class="btn btn-sm btn-warning">Reset</a>
                    @endif
            </form>
                ...
                <tbody>
                    @foreach($practiceDialogues as $practiceDialogue)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.mock-tests.edit', $practiceDialogue->id) }}" class="btn btn-sm btn-warning">Edit</a>
