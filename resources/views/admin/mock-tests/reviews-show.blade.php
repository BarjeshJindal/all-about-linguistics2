...
@extends('layouts.vertical', ['title' => $mockTest->mock_test_title, 'topbarTitle' => $mockTest->mock_test_title])
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
                        ...
                        <div class="mocktest-box mb-2">
                            ...
                            <div class="container">
                                <div class="row p-2">
                                    ...
                                    <!-- Student Audio -->
                                    <div class="audio col-sm-4">
                                        <h3 class="dialogue-title">Student Audio</h3>
            ...
            <form class="p-3 border rounded bg-light" method="POST"
                action="{{ route('admin.mocktest.feedback.update') }}">
                @csrf
                <input type="hidden" name="id" value="{{ $mockTest->user_mock_test_id }}">

                <h2 class="feedback-title mb-3">Feedback</h2>

                @if (is_null($mockTest->score))
                    {{-- Show input form if score is null --}}
                    <div class="row align-items-end">
                        <div class="col-md-3">
                            <label for="score" class="form-label">Score</label>
                            <input type="number" class="form-control" name="score" id="score" placeholder="Score">
                        </div>
                        <div class="col-md-6">
                            <label for="notes" class="form-label">Notes</label>
                            <textarea class="form-control" name="feedback" id="notes" rows="1" placeholder="Enter notes..."></textarea>
                        </div>
                        <div class="col-md-3">
                            <button type="submit" class="btn submit-btn w-100 mt-2">Submit</button>
                        </div>
                    </div>
                @else
