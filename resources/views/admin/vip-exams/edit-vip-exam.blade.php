@extends('layouts.vertical', ['title' => 'Edit Vip Exam', 'topbarTitle' => 'Edit Vip Exam'])
...
<div class="card shadow-sm border-0">
    <div class="card-body">
        ...
        <form action="{{ route('admin.vip-exams.update',$practiceDialogue->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
