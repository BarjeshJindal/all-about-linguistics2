@extends('layouts.vertical', ['title' => 'Vip Exam', 'topbarTitle' => 'Create Vip Exam'])
...
@section('content')
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.vip-exams.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="description" rows="5" id="exam_description"></textarea>
                </div>
                <div class="mb-3">
            ...
            <div id="segment-wrapper">
                <div class="segment-block mb-4 mt-4 border p-6 rounded-2xl bg-light">
                    <h4 class="segment-title p-2">Segment 1</h4>
                    <div class="mb-1 p-2">
                   ...
                   <div class="mb-1 p-2">
                                    ...
                                    <input type="file" name="segments[0][sample_response]"
    ...
    <script>
        ...
        document.getElementById('add-segment').addEventListener('click', function() {
            ...
            newBlock.innerHTML = `
                    <h4 class="segment-title p-2">Segment ${segmentIndex + 1}</h4>   <!-- ✅ heading -->
                    <div class="mb-3 p-2">
                        <label class="form-label">Audio File(MP3)</label>
                     ...
                     <div class="mb-1 p-2">
                                    <label class="form-label">Sample Response (MP3)</label>
                                    <input type="file" name="segments[${segmentIndex}][sample_response]"
                                        class="form-control" accept=".mp3,.wav">
                    </div>
                    <div class="row p-2">
